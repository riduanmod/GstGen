...
def generate_account(
    ...
    # FIX: Use exact provided name (Only replacing normal spaces with invisible spaces as required by the game)
    ...
    try:
        ...
        return AccountResponse(
            ...
            account_name=final_account_name, # Returns exact name without superscripts
            uid=uid,
