...
def generate_account(
    ...
    # Define Login Host based on CLI logic
    ...
    try:
        ...
        # JWT Extraction logic from CLI script
        if res_ml.status_code == 200 and len(res_ml.content) > 0:
            ...
            # Fallback to text parsing if Protobuf failed or unavailable
        ...
        if region_code != "BR":
            ...
            # Fire and forget region binding
        ...
        # Return Success Response Matching the Exact Model
        return AccountResponse(
            status="success",
            message="Account generated successfully using OB52 logic.",
            is_active=True,  # Set to True as generation flow completed
